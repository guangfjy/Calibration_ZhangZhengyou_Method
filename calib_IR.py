...
def calib(inter_corner_shape, size_per_grid, img_dir, img_type):
    ...
    # (0,1,0), (1,1,0), (2,1,0), ..., (10, 1, 0)
    # (0,2,0), (1,2,0), (2,2,0), ..., (10, 2, 0)
    # ...
    # (0,7,0), (1,7,0), (2,7,0), ..., (10, 7, 0)
    cp_int = np.zeros((w * h, 3), np.float32)  # 每个角点的世界坐标为(X,Y,Z)
    ...
    images = glob.glob(img_dir + os.sep + '**.' + img_type)  # 找到18个样本
    for fname in images:
...
if __name__ == '__main__':
    inter_corner_shape = (11, 8)  # 棋盘格内角点个数
    size_per_grid = 0.02  # 棋盘格格点长度
    img_dir = "./pic/IR_camera_calib_img"  # 矫正图片保存目录
    img_type = "png"  # 样本图像格式
